...
const style = {
  ...
  otherInfo: `flex`,
  ownedBy: `text-[#5ac69f] mr-4`,
  likes: `flex items-center text-[#5ac69f]`,
  likeIcon: `mr-1`,
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Pixel Freshness</div>
        <div className={style.nftTitle}>{selectedNft?.name}</div>
        <div className={style.otherInfo}>
          <div className={style.ownedBy}>
            Owned by <span className={style.accent}>JonnathanAndrade</span>
          </div>
